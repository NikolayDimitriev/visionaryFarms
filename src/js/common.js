    ...
    if($('.js-install-animation').length > 0){
        $(window).scroll(function() {
            ...
            if(scroll > installTop - 240){
                if(!$('.js-install-animation .image-wrapper').hasClass('animated')){
                    $('.js-install-animation .image-wrapper').addClass('animated');
                    setTimeout(function (){
                        $('.js-install-animation .image-wrapper').removeClass('animated');
                    }, 15000);
                }
            }
        });
        $('.js-install-animation .image-wrapper').hover(
            function (){
                if(!$(this).hasClass('animated')){
                    $('.js-install-animation').find('.image-wrapper').addClass('animated');
                    setTimeout(function (){
                        $('.js-install-animation').find('.image-wrapper').removeClass('animated');
                    }, 15000);
                }
            }),
            function (){
    ...
    if($('.message-section__form').length > 0){
        ...
        $fileInput.on('change', function () {
            ...
            if (filesCount === 1) {
                ...
                $('.message-section__form .item-delete').css('display', 'inline-block');
